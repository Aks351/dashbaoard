  ...
  "departments": [
    ...
    },
    {
      ...
      "metrics": [
        ...
        {
          "id": "rec_dipesh_apps",
          "name": "Dipesh — Applications",
          "sub": "Recruiter: Dipesh",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "rec_dipesh_onboard",
          "name": "Dipesh — Onboarded",
          "sub": "Recruiter: Dipesh",
          "unit": "",
          "dir": "higher",
          "total": false,
        ...
        {
          "id": "rec_madhu_onboard",
          "name": "Madhu — Onboarded",
          "sub": "Recruiter: Madhu",
          "unit": "",
          "dir": "higher",
          "total": false,
        ...
        {
          "id": "pos_dipesh_tenderexecutive_apps",
        ...
        {
          "id": "pos_dipesh_tenderexecutive_final",
          "name": "Tender Executive — Final Rounds",
          "sub": "Recruiter: Dipesh · Position: Tender Executive · Final Rounds",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_dipesh_tenderexecutive_onboard",
          "name": "Tender Executive — Onboarded",
          "sub": "Recruiter: Dipesh · Position: Tender Executive · Onboarded",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_dipesh_plantoperationsmanager_apps",
          "name": "Plant Operations Manager — Applications",
        ...
        {
          "id": "pos_dipesh_plantoperationsmanager_final",
          "name": "Plant Operations Manager — Final Rounds",
          "sub": "Recruiter: Dipesh · Position: Plant Operations Manager · Final Rounds",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_dipesh_plantoperationsmanager_onboard",
          "name": "Plant Operations Manager — Onboarded",
          "sub": "Recruiter: Dipesh · Position: Plant Operations Manager · Onboarded",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_madhu_pc_apps",
          "name": "PC — Applications",
          "sub": "Recruiter: Madhu · Position: PC · Applications",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_madhu_pc_final",
          "name": "PC — Final Rounds",
          "sub": "Recruiter: Madhu · Position: PC · Final Rounds",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_madhu_pc_onboard",
          "name": "PC — Onboarded",
          "sub": "Recruiter: Madhu · Position: PC · Onboarded",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_madhu_crmsales_apps",
          "name": "CRM/Sales — Applications",
          "sub": "Recruiter: Madhu · Position: CRM/Sales · Applications",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_madhu_crmsales_final",
          "name": "CRM/Sales — Final Rounds",
          "sub": "Recruiter: Madhu · Position: CRM/Sales · Final Rounds",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_madhu_crmsales_onboard",
          "name": "CRM/Sales — Onboarded",
          "sub": "Recruiter: Madhu · Position: CRM/Sales · Onboarded",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_madhu_senioraccountant_apps",
          "name": "Senior Accountant — Applications",
          "sub": "Recruiter: Madhu · Position: Senior Accountant · Applications",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_madhu_senioraccountant_final",
          "name": "Senior Accountant — Final Rounds",
          "sub": "Recruiter: Madhu · Position: Senior Accountant · Final Rounds",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_madhu_senioraccountant_onboard",
          "name": "Senior Accountant — Onboarded",
          "sub": "Recruiter: Madhu · Position: Senior Accountant · Onboarded",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_dipesh_accountantdausa_apps",
          "name": "Accountant -Dausa — Applications",
          "sub": "Recruiter: Dipesh · Position: Accountant -Dausa · Applications",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_dipesh_accountantdausa_final",
          "name": "Accountant -Dausa — Final Rounds",
          "sub": "Recruiter: Dipesh · Position: Accountant -Dausa · Final Rounds",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
        ...
        {
          "id": "pos_dipesh_accountantdausa_onboard",
          "name": "Accountant -Dausa — Onboarded",
          "sub": "Recruiter: Dipesh · Position: Accountant -Dausa · Onboarded",
          "unit": "",
          "dir": "higher",
          "total": false,
          "plan": {
...
export const STAGES = [['Applications', 'apps'], ['Final Rounds', 'final'], ['Offer Given To', 'offer'], ['Onboarded', 'onboard']];
...
export function KpiProvider({ children }) {
  ...
  const addWeek = (label, range) => {
    ...
    newModel.departments.forEach(d => {
      d.metrics.forEach(m => {
        ...
        if (d.id === 'crm') { m.ontime = m.ontime || {}; m.ontime[id] = ''; }
      });
    });
    setActiveWeek(id);
    saveToLocal(newModel);
  ...
  const removeWeek = (id) => {
    ...
    newModel.departments.forEach(d => {
      d.metrics.forEach(m => {
        ...
        if (m.ontime) delete m.ontime[id];
      });
    });
  ...
  const addHiringRole = (recruiter, role) => {
    ...
    const stages = [
      ...
      { id: `${baseId}_onboard`, name: `${role} — Onboarded`, sub: `Recruiter: ${recruiter} · Position: ${role} · Onboarded` }
    ];
